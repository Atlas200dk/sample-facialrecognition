...
1.  <a name="zh-cn_topic_0182554631_li953280133816"></a>获取源码包。
    ...
    将[https://github.com/Atlas200DKTest/sample-facialrecognition](https://github.com/Atlas200DKTest/sample-facialrecognition)仓中的代码以Mind Studio安装用户下载至Mind Studio所在Ubuntu服务器的任意目录，例如代码存放路径为：$HOME/sample-facialrecognition。
